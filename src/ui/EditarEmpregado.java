...
public class EditarEmpregado extends javax.swing.JFrame {
     ...
     */
    public EditarEmpregado(Employee emp) {
        initComponents();
        this.emp = emp;
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Editar informações de empregado");
    ...
    private void BotaoSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoSalvarActionPerformed
        ...
        try {
            ...
            try {
                EmployeeDAO.EditarEmpregadoPorCpf(conn, cpf, rg, nome, sexo, salario, cpf_gerente);
                // Alerta usuario e fecha janela de criacao

                JOptionPane.showMessageDialog(null, "Empregado editado com sucesso. Atualize a lista de empregados para visualizar as modificações.");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        NovoEmpregadoCPF.setText(emp.getCPF());
        NovoEmpregadoNome.setText(emp.getNome());
        NovoEmpregadoRG.setText(emp.getRG());
        NovoEmpregadoSalario.setText(Integer.toString(emp.getSalario()));
        NovoEmpregadoCPFGerente.setText(emp.getGerenteCpf());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new EditarEmpregado(this.emp).setVisible(true);
            }
        });
    }
